      ...
      return (
        <div>
          <Row css={{ marginTop: "$1" }}>
            ...
            <img src="ethereumlogo.svg" width={"160px"} />
          </Row>
          <Row>
      ...
      return (
        <div>
          <Row css={{ marginTop: "$1" }}>
            ...
            <img src="binance.svg" width={"190px"} />
          </Row>
          <Row>
            <Text css={{ marginTop: "$6", marginRight: "$2" }} h4>
              NFT ID:
      ...
      return (
        <div>
          <Row css={{ marginTop: "$1" }}>
            ...
            <img src="polygon.svg" width={"190px"} />
          </Row>
          <Row>
            <Text css={{ marginTop: "$6", marginRight: "$2" }} h4>
              NFT ID:
      ...
      return (
        <div>
          <Row>
            <Col>
              <Text h4>Bridge Source</Text>
              <img src="polygon.svg" width={"210px"} />
            </Col>
            <Col css={{ marginTop: "$12", paddingLeft: "$12" }}>
              <div style={{ marginTop: "5px" }} id="arrowAnim">
                <div className="arrowSliding">
      ...
      return (
        <div>
          <Row>
            <Col>
              <Text h4>Bridge Source</Text>
              <img src="binance.svg" width={"210px"} />
            </Col>
            <Col css={{ marginTop: "$12", paddingLeft: "$12" }}>
              <div style={{ marginTop: "5px" }} id="arrowAnim">
                <div className="arrowSliding">
    ...
    <div>
      ...
      <Container sm="true">
        ...
        <Grid>
          ...
          >
            The&nbsp; Gamesets&nbsp; asset&nbsp; bridge&nbsp; is&nbsp;
            meant&nbsp; to&nbsp; do&nbsp; one&nbsp; thing,&nbsp; provide&nbsp;
            a&nbsp; transport mechanism&nbsp; to&nbsp; safely&nbsp; move
            Tokens&nbsp; and&nbsp; NFTs&nbsp; between&nbsp; participating&nbsp;
            blockchains!
          </Text>
          <p style={{ fontSize: "20px", margin: "30px", fontWeight: "200" }}>
            This&nbsp; is&nbsp; all&nbsp; under&nbsp; a&nbsp; single&nbsp;
            convenient &nbsp; dashboard. &nbsp; The &nbsp; transfer process is
      ...
      <Container sm="true">
        ...
        <Card css={{ $$cardColor: "#00000042", marginBottom: "$5" }}>
          ...
          >
            Pay with
            <img className="ml-3" src="gameSets.svg" width="100px" />
          </Checkbox>
